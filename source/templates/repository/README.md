...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/jaderdias/metrics/blob/examples/metrics.repository.svg" alt=""></img>
...
*Example: render `jaderdias/metrics` repository*
```yml
...
with:
  ...
  plugin_followup: yes
  plugin_projects: yes
  plugin_projects_repositories: jaderdias/metrics/projects/1
